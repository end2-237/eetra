...
export default function AdminDocuments() {
  ...
  const [currentPath] = useState('/admin/documents')
      ...
      <div className="db-main">
        ...
        <div className="db-body">
          <div className="db-center">
            <div className="admin-title">Statistiques des documents</div>
            <div className="admin-desc">Analyse et gestion des documents de la plateforme</div>
            <div className="db-block" style={{ textAlign: 'center', padding: '40px' }}>
              <div className="placeholder-text">Statistiques à venir</div>
            </div>
          </div>
        </div>
      </div>

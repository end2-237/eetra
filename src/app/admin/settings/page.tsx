...
export default function AdminSettings() {
  ...
  const [currentPath] = useState('/admin/settings')
  ...
  return (
    <div className="db">
      ...
      <div className="db-main">
        ...
        <div className="db-body">
          <div className="db-center">
            <div className="admin-title">Paramètres de la plateforme</div>
            <div className="admin-desc">Configuration générale et avancée</div>

            <div className="settings-section">
              <div className="settings-title">Général</div>
              <div className="setting-item">
                <div className="setting-label">Nom de la plateforme</div>
                <div style={{ fontWeight: '600' }}>EETRA</div>
              </div>
              <div className="setting-item">
              ...
              <div className="setting-item">
                <div className="setting-label">Environnement</div>
                <div style={{ fontWeight: '600' }}>Production</div>
              </div>
            </div>

            <div className="settings-section">
              <div className="settings-title">Plans et tarification</div>
              <div className="setting-item">
                <div className="setting-label">Plan Starter</div>
                <div style={{ fontWeight: '600', color: 'var(--text3)' }}>Gratuit</div>
              </div>
              <div className="setting-item">
                <div className="setting-label">Plan Pro</div>
                <div style={{ fontWeight: '600', color: 'var(--accent)' }}>Personnalisable</div>
              </div>
              <div className="setting-item">
                <div className="setting-label">Plan Business</div>
                <div style={{ fontWeight: '600', color: 'var(--accent)' }}>Personnalisable</div>
              </div>
            </div>

            <div className="settings-section">
              <div className="settings-title">Fonctionnalités</div>
              <div className="setting-item">
                <div className="setting-label">Authentification à deux facteurs</div>
                <div style={{ fontWeight: '600', color: 'var(--success)' }}>Activé</div>
              </div>
              <div className="setting-item">
              ...
              <div className="setting-item">
                <div className="setting-label">API publique</div>
                <div style={{ fontWeight: '600', color: 'var(--success)' }}>Activé</div>
              </div>
            </div>
          </div>
      ...
      <style>{`
        ...
        .settings-section { border:1px solid var(--border); border-radius:7px; background:var(--surface); padding:20px; margin-bottom:16px; }

...
export default function SettingsPage() {
  ...
  const inputClass =
    "w-full rounded-xl px-3.5 py-2.5 text-[13px] border outline-none font-sans transition-all";
  const inputStyle = {
    background: "var(--bg2)",
  ...
  const handleLogoChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    r.onload = (ev) =>
      updateProfile({ logoDataUrl: ev.target?.result as string });
    r.readAsDataURL(f);
  };
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="sticky top-0 z-10 h-14 border-b flex items-center justify-between px-8"
              ...
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <p className="text-[13px]" style={{ color: "var(--text3)" }}>
                    Ces informations apparaissent sur tous vos documents.
                  </p>
                </div>
                    ...
                    <div>
                      ...
                      {profile.logoDataUrl && (
                        <button
                          ...
                          className="mt-2 text-[10px] cursor-pointer border-none bg-transparent block text-center w-full"
                    ...
                    <div className="flex-1 grid grid-cols-1 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          style={inputStyle}
                          placeholder="Ex : QUANTUM INDUSTRIES SAS"
                          value={profile.name}
                          onChange={(e) =>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              updateProfile({ sector: e.target.value })
                            }
                            onFocus={focusStyle}
                            onBlur={blurStyle}
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            value={profile.legal}
                            onChange={(e) =>
                              updateProfile({ legal: e.target.value })
                            }
                            onFocus={focusStyle}
                            onBlur={blurStyle}
                          >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      },
                      {
                        label: "Email",
                        key: "email",
                        ph: "contact@entreprise.com",
                      },
                      {
                        label: "Site Web",
                        key: "web",
                        ph: "www.entreprise.com",
                      },
                      {
                        label: "RCCM / N° Fiscal",
                        key: "siret",
                        ph: "CI-ABJ-2024-B-0001",
                      },
                      {
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateProfile({ signer: e.target.value })
                        }
                        onFocus={focusStyle}
                        onBlur={blurStyle}
                      />
                  ...
                  >
                    <div>
                      ...
                      >
                        Afficher "Généré par EETRA" en pied de page
                      </p>
                    </div>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <div
                        onClick={() =>
                          updateProfile({ watermark: !profile.watermark })
                        }
                ...
                <Button
                  variant="primary"
                  size="md"
                  onClick={() => showToast("Profil sauvegardé", "ok")}
                >
            ...
            {activeTab === "appearance" && (
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <p className="text-[13px]" style={{ color: "var(--text3)" }}>
                    Personnalisez l'interface et la couleur corporate.
                  </p>
                </div>
                ...
                >
                  ...
                  <div className="flex gap-3">
                    {[
                      ...
                      <div
                        key={t.id}
                        className="flex-1 rounded-xl border-2 p-4 cursor-pointer text-center"
                    ...
                    {PALETTE.map((c) => (
                      <button
                        ...
                        style={{
                          background: c,
                          borderColor:
                            profile.color === c ? "var(--text)" : "transparent",
            ...
            {activeTab === "notifications" && (
              <div className="flex flex-col gap-6">
                ...
                >
                  {sectionTitle && (
                    <div
                      className="px-6 pt-5 text-[10px] font-bold uppercase tracking-widest"
                      style={{ color: "var(--text4)" }}
                    >
                      Préférences Email
                    </div>
                  ...
                  <div className="p-6 pt-3">
                    {[
                      {
                        key: "exports",
                        label: "Exports de documents",
                        desc: "Recevoir une confirmation à chaque export PDF",
                      },
                      {
                        key: "comments",
                        label: "Nouveaux commentaires",
                        desc: "Être notifié lors de nouvelles annotations",
                      },
                      {
                        key: "team",
                        label: "Activité équipe",
                        desc: "Modifications et ajouts de membres",
                      },
                      {
                        key: "updates",
                      ...
                      },
                      {
                        ...
                        desc: "Conseils, tutoriels et promotions",
                      },
                    ].map((pref) => (
                      <div
                        key={pref.key}
                        ...
                        <div
                          onClick={() =>
                            setNotifPrefs((p) => ({
                              ...p,
                              [pref.key]:
                                !p[pref.key as keyof typeof notifPrefs],
                            }))
                          }
                          className="w-5 h-5 rounded border-2 flex items-center justify-center cursor-pointer transition-all"
                          style={
                ...
                <Button
                  variant="primary"
                  size="md"
                  onClick={() => showToast("Préférences sauvegardées", "ok")}
                >
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div
                        ...
                        style={{ color: "var(--text4)" }}
                      >
                        Navigateur web · Abidjan, CI · En cours
                      </div>
                    </div>
                    <span
              ...
              <div className="flex flex-col gap-6" id="plan">
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      {
                        label: "Pages par document",
                        value:
                          plan.maxPagesPerDoc === Infinity
                            ? "Illimitées"
                            : String(plan.maxPagesPerDoc),
                      },
                      {
                        ...
                        value:
                          plan.maxDocsPerMonth === Infinity
                            ? "Illimités"
                            : String(plan.maxDocsPerMonth),
                      },
                      {
                        label: "IA rédactionnelle",
                        value: plan.ai ? "Inclus" : "Non inclus",
                      },
                      {
                        label: "Sans filigrane",
                        value: plan.canRemoveWatermark
                          ? "Disponible"
                          : "Non disponible",
                      },
                    ].map(({ label, value }) => (
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "var(--text4)" }}
                  >
                    Pour toute demande de facturation ou de remboursement,
                    contactez-nous à billing@eetra.app
                  </p>
                </div>
                ...
                >
                  ...
                  <div className="text-center py-6">
                    <Download
                      size={28}
                      style={{ color: "var(--text4)", margin: "0 auto 8px" }}
                    />
                    <p
                      className="text-[12px]"
                      style={{ color: "var(--text4)" }}
